<%-- 
    Document   : A_Negative
    Created on : Jun 3, 2021, 11:16:44 AM
    Author     : anura
--%>
                                         ...
                                         <table class="table table-striped table-hover">
                                             ...
                                             <tbody>
                                                 ...
                                                 <tr class="text-center">
                                                     ...
                                                     <td><button class="btn btn-danger edit_ap_doner" data-toggle="modal" ><i class="fa fa-edit">&nbsp;</i></button></td>
                                           ...
                                           <!--Edit A+ Blood Doner-->       
   <div class="modal fade" id="edit_ap_doner" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body bg-dark text-white">
          <form id="an_form" action="edit_ap_doner.jsp">
...
<script type="text/javascript" src="files/boot3.js"></script>
    ...
    <script>
        $(document).ready(function(){      
                     $('.edit_ap_doner').on('click',function(){
                     $('#edit_ap_doner').modal('show');
                     $tr=$(this).closest('tr');   
