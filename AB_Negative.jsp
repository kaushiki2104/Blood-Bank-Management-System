<%-- 
    Document   : AB_Negative
    Created on : Jun 3, 2021, 11:59:43 AM
    Author     : anura
--%>
                                         ...
                                         <table class="table table-striped table-hover">
                                             ...
                                             <tbody>
                                                 ...
                                                 <tr class="text-center">
                                                     ...
                                                     <td><button class="btn btn-danger edit_abn_doner" data-toggle="modal" ><i class="fa fa-edit">&nbsp;</i></button></td>
                                           ...
                                           <!--Edit AB- Blood Doner-->       
   <div class="modal fade" id="edit_abn_doner" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body bg-dark text-white">
          <form id="an_form" action="edit_abn_doner.jsp">
...
<script type="text/javascript" src="files/boot3.js"></script>
    ...
    <script>
        $(document).ready(function(){      
                     $('.edit_abn_doner').on('click',function(){
                     $('#edit_abn_doner').modal('show');
                     $tr=$(this).closest('tr');   
