<%-- 
    Document   : Login
    Created on : Jan 15, 2021, 12:47:55 AM
            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form action="login_admin.jsp" method="post">
                ...
                <div class="form-label-group">
                  ...
                  <input type="password" name="pswd" id="password" class="form-control" placeholder="Password" required>
                </div>
                <div class="form-label-group">
                    <label for="inputPassword">ConfirmPassword</label>
                  <input type="password" name="cpswd" id="confirm_password" class="form-control" placeholder="Confirm Password" required>
                </div>
                  <div>
                      <span id='message'></span>
                  </div>
<!--                                      <div class="form-row">
                                      <div class="g-recaptcha" id="rcaptcha" data-sitekey="6Lc-yYUaAAAAABSw8R6vXY2zXAo5awUQdpRtivBT"></div>
                                       </div>-->
